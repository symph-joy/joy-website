...
exports.themeColorStyle = exports.themeColors = void 0;
const DaybreakBlueStyle = `
  :root {
...
`;
const themeColors = {
  daybreakBlue: "rgb(24, 144, 255)",
  dustRed: "rgb(245, 34, 45)",
  volcano: "rgb(250, 84, 28)",
  sunsetOrange: "rgb(250, 173, 20)",
  cyan: "rgb(19, 194, 194)",
  polarGreen: "rgb(82, 196, 26)",
  geekBlue: "rgb(24, 144, 255)",
  goldenPurple: "rgb(114, 46, 209)"
};
exports.themeColors = themeColors;
const themeColorStyle = {
  daybreakBlue: DaybreakBlueStyle,
  dustRed: DustRedStyle,
  volcano: VolcanoStyle,
  sunsetOrange: SunsetOrangeStyle,
  cyan: CyanStyle,
  polarGreen: PolarGreenStyle,
  geekBlue: GeekBlueStyle,
  goldenPurple: GoldenPurpleStyle
};
exports.themeColorStyle = themeColorStyle;
...
function changeTheme() {
  ...
  const oLink = document.getElementById("theme-style");
...
function changeThemeColor(themeColor) {
  const oStyle = document.getElementById("theme-color");
  document.documentElement.style.setProperty("--theme-color", themeColors[themeColor]);
  localStorage.setItem("themeColor", themeColor);
  oStyle.innerHTML = themeColorStyle[themeColor];
}